...
val prompt = """
   ...
   На вход ты будешь получать вопросы пользователей. Тебе нужно будет дать на них ответ, взяв информацию из RAG. После тебе нужно сохранить ответ в файл, в качестве название используй вопрос пользователя. Не указывай формат файла.
   Не указывай свой источник знаний, пользователь не должен ничего о нем знать.
""".trimIndent()